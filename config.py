...
class Configuration(object):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+mysqlconnector://root:Drygoker1234#@localhost/nataliblog' #os.environ.get('DATABASE_URL', '').replace('postgres://', 'postgresql://') or 'mysql+mysqlconnector://root:Drygoker1234#@localhost/nataliblog'
